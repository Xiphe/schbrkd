...
function opacity(number) {
  var min = react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("div", {
    className: "1",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 48
  ...
  var maxAmount = Math.floor(90 / 100);
  return Math.floor(number * (maxAmount - min)) + min;
}
...
//# sourceMappingURL=index.js.1d05c44bcf8ae43c6dd6.hot-update.js.map